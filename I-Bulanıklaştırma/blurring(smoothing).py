...
# gaussian noise kullanılarak gürültülü bir resim elde etme fonksiyonu
...
img = cv2.imread("NYC.jpg")
# piksel değerlerini 0-255 'den 0-1 arasına çekiyoruz
img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)/255
plt.figure(),plt.imshow(img),plt.axis("off"),plt.title("orijinal"),plt.show()

# resmi fonksiyonu kullanarak gürültülü hale getirmiş oluyoruz
gaussianNoisyImage = gaussianNoise(img)
plt.figure(),plt.imshow(gaussianNoisyImage),plt.axis("off"),plt.title("Gauss Noisy"),plt.show()

# gauss blur ile gürültü azaltma işlemi 
...
# tuz ve karabiber gürültü fonksiyonu 
...
# tuz ve karabiber gürültüsü kullanarak bir görüntü elde ettik 
spImage = saltPepperNoise(img)   
plt.figure(), plt.imshow(spImage), plt.axis("off"), plt.title("SP Image")

# gürültülü görüntüyü median blur kullanarak düzeltmeye çalışıyoruz
